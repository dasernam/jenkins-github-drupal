 ...
 *   also be "maintenance_page" since dcamp_demo_preprocess_maintenance_page() calls
 *   this function to have consistent variables.
 */
function dcamp_demo_preprocess_html(&$variables, $hook) {
  // Add variables and paths needed for HTML5 and responsive support.
  $variables['base_path'] = base_path();
  $variables['theme_path'] = drupal_get_path('theme', 'dcamp_demo');
 ...
 */
function dcamp_demo_process_html(&$variables, $hook) {
 ...
 */
function dcamp_demo_preprocess_page(&$variables, $hook) {
 ...
 *   An array of variables to pass to the theme template.
 */
function dcamp_demo_process_page(&$variables) {
 ...
 */
function dcamp_demo_preprocess_node(&$variables, $hook) {
 ...
 */
function dcamp_demo_preprocess_comment(&$variables, $hook) {
 ...
 */
function dcamp_demo_preprocess_taxonomy_term(&$variables) {
  // Add a suggestion based on view_mode.
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function dcamp_demo_preprocess_block(&$variables, $hook) {
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function dcamp_demo_process_block(&$variables, $hook) {
 ...
 *   An array of variables to pass to the theme template.
 */
function dcamp_demo_preprocess_panels_pane(&$variables) {
 ...
 */
function dcamp_demo_css_alter(&$css) {
